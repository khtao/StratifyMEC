from source.emb_position import *
from source.rmsa import *
from source.nystrom_attention import NystromAttention
from source.datten import DAttention
...
class RRTMILFeat(nn.Module):
    def __init__(self, input_dim=1024, mlp_dim=512, act='relu', dropout=0.25, pos_pos=0, pos='none',
                 peg_k=7, attn='rmsa', pool='attn', region_num=8, n_layers=2, n_heads=8, drop_path=0., da_act='relu',
                 trans_dropout=0.1, ffn=False, ffn_act='gelu', mlp_ratio=4., da_gated=False, da_bias=False,
                 da_dropout=False, trans_dim=64, epeg=True, min_region_num=0, qkv_bias=True, **kwargs):
        super(RRTMILFeat, self).__init__()
...
if __name__ == "__main__":
    ...
    # x_rrt = dropout(x_rrt)rand
    rrt = RRTMILFeat(input_dim=768, mlp_dim=768, epeg_k=15, crmsa_k=3)
